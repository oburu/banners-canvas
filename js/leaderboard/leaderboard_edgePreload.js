...
(function(compId) {
    ...
    function findNWC(a, d) {
        ...
        for (var b = a.childNodes, k = 0; k < b.length; k++) {
            var f = findNWC(b[k], d);
            if (!1 != f) return f
        }
        return !1
        ...
        if (!isWrapped(a)) {
            var b = function() {
                var b = isWrapped(a),
                    ...
                    e = 1,
                    l = a.style;
                (f = "body" === f.nodeName.toLowerCase()) && (g = m);
                c = Math.round(c);
                g = Math.round(g);
                c /= h;
                g /= n;
                "both" === d ? e = Math.min(c, g) : "height" === d ? e = g : "width" === d && (e = c);
                void 0 !== maxPlW && (e = Math.min(e, parseInt(maxPlW, 10) / h));
                void 0 !== minPlW && (e = Math.max(e, parseInt(minPlW, 10) / h));
                g = "scale(" + e + ")";
                ...
                l.mozTransform = g;
                l.oTransform = g;
                if (!f || b) parent(a).style.height = Math.round(n * e) + "px", parent(a).style.width = Math.round(h * e) + "px";
    ...
    function simpleContent(a, d, b) {
        var k = document.getElementsByTagName("body")[0],
            f = b || findNWC(k, compId),
            c, g, h;
        f ? "absolute" != f.style.position && "relative" != f.style.position && (f.style.position = "relative") : f = k;
        ...
        for (var n = 0; n < a.length; n++) {
            b = a[n];
            "image" === b.type ? (k = document.createElement("img"), k.src = b.fill[1]) : k = document.createElement("div");
            k.id = b.id;
            h = k.style;
            if ("text" == b.type) {
                if (c = b.font) c[0] && "" !== c[0] && (h.fontFamily = c[0]), "object" != typeof c[1] && (c[1] = [c[1]]), c[1][1] || (c[1][1] = "px"), c[1][0] && "" !== c[1][0] && (h.fontSize = c[1][0] + c[1][1]), c[2] && "" !== c[2] && (h.color = safeColor(c[2])), c[3] && "" !== c[3] && (h.fontWeight = c[3]), c[4] && "" !== c[4] && (h.textDecoration = b.font[4]), c[5] && "" !== c[5] && (h.fontStyle = b.font[5]);
                b.align && "auto" != b.align && (h.textAlign = b.align);
                b.position && (h.position = b.position);
                (!b.rect[2] || 0 >= b.rect[2]) && (!b.rect[3] || 0 >= b.rect[3]) && (h.whiteSpace = "nowrap");
                k.innerHTML = b.text
            }
            d && (k.className = d);
            h.position = "absolute";
            ...
            if (b.transform && b.transform[0]) {
                ...
                if (1 < b.transform[0].length) {
                    ...
                    if (e = splitUnits(g)) g = e.num;
                    g += m;
                    e.units || (e.units = "px");
                    g += e.units
                }
            }
            h.left = defaultUnits(c);
            h.top = defaultUnits(g);
            h.width = defaultUnits(b.rect[2]);
            h.height = defaultUnits(b.rect[3]);
            b.linkURL && (htLookup[k.id] = b, k.onclick = function() {
                var a = htLookup[this.id];
                a.linkTarget ? window.open(a.linkURL, a.linkTarget) : window.location.href = a.linkURL
            }, h.cursor = "pointer");
            f.appendChild(k);
            if (b.c)
                for (h = 0; h < b.c.length; h++) simpleContent(b.c[h], d, k)
        }
    }
    ...
    htFallbacks = {
        ...
        "edge_includes/edge.3.0.0.min.js": "//animate.adobe.com/runtime/3.0.0/edge.3.0.0.min.js"
    };
    aLoader = [{
        ...
        load: "./js/leaderboard/leaderboard_edge.js"
    }, {
        load: "./js/leaderboard/leaderboard_edgeActions.js"
    }];
    ...
    preContent = {
        dom: [{
            ...
            type: 'image',
            tag: 'img',
            rect: ['333', '36px', '62px', '18px', 'auto', 'auto'],
            fill: ["rgba(0,0,0,0)", './images/preloader22.gif', '0px', '0px']
        }]
    };
    //simpleContent
    dlContent = {
